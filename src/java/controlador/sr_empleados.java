...
public class sr_empleados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //Clientes
                        cliente = new Cliente(request.getParameter("txt_nit"),Integer.valueOf(request.getParameter("txt_id")),request.getParameter("txt_nombres"),request.getParameter("txt_apellidos"),request.getParameter("txt_direccion"),request.getParameter("txt_telefono"),request.getParameter("txt_fn"));

             if ("agregar".equals(request.getParameter("btn_agregarC"))){
            ...
            // Boton modificar 
            if ("modificar".equals(request.getParameter("btn_modificarC"))){
            ...
            // Boton eliminar 
            if ("eliminar".equals(request.getParameter("btn_eliminarC"))){
