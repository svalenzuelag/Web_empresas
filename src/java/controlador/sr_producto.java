...
public class sr_producto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            producto = new Producto(Integer.valueOf(request.getParameter("txt_existencia")),Integer.valueOf(request.getParameter("drop_marca")),Float.valueOf(request.getParameter("txt_precioC")),Float.valueOf(request.getParameter("txt_precioV")),Integer.valueOf(request.getParameter("txt_id")),request.getParameter("txt_producto"),request.getParameter("txt_descripcion"));
            // Boton agregar 
